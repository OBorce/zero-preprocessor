...
add_custom_command(
    ...
    DEPENDS ${CMAKE_SOURCE_DIR}/../../src/parse_source.py # the parser script as a dependency
	...
	foreach(src ${sources})
        ...
        if(src MATCHES \\.\(${allowed_file_extensions}\)$ AND NOT src MATCHES ${excluded_file_patterns})
            ...
            add_custom_command(
                ...
                COMMAND python ${CMAKE_SOURCE_DIR}/../../src/parse_source.py ${src} ${gen} # call the python script with the 2 filenames
